...
parser.add_argument('-bleu', help="Ref file for BLEU")
...
def main():
    ...
    if tgtF:
        tgtF.close()
    print("Avg Decode Time: ",(sum(alltimes)/len(alltimes)))
    print("Max Decode Time: ",max(alltimes))
    if opt.bleu and opt.output:
      corpus_bleu.bleu(opt.output,opt.bleu)
